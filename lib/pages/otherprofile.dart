...
class OtherProfile extends StatefulWidget with NavigationStates{
  String username="";
  String firstname="";
  String lastname="";
  String gender="";
  ...
  int tripid=0;
  String ratingtotal="";
  OtherProfile(this.tripid,this.ratingtotal,this.username,this.firstname,this.lastname,this.gender,this.rating,this.review,this.trust12,this.trust21);
  @override
                                  ...
                                  children: <Widget>[
                                    ...
                                    /*CupertinoRadioChoice(
                                        ...
                                        onChange: (selectedGender) {
                                          widget.trust12=int.parse(selectedGender);
                                        },
                                        initialKeyValue: widget.trust12.toString()
                                    ),*/
                                    widget.review==""?
                                    Padding(
                                      padding: const EdgeInsets.all(10.0),
                                          ...
                                          onPressed: (){
                                            ...
                                            void updateRating() async{
                                              Map<String, String> body = {
                                                ...
                                                "rating": getDisplayRating(widget.rating),
                                                "datetime":DateTime.now().toString(),
                                              };
                                              print(token);
                                              String url = "http://3.81.22.120:3000/api/addrating";
                                            ...
                                            updateRating();
                                            if (reviewController.text != changereview) {
                                              print("Old: "+changereview);
                                              print("New: "+reviewController.text);
                                              void updateReview() async{
                                                ...
                                                print(body);
                                                String url = "http://3.81.22.120:3000/api/addreview";
                                                Response response = await post(
                                                    url, body: body,
                                                    headers: {
                                                      'authorization': token
