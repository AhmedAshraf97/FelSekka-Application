...
class TrackingFrom extends StatefulWidget {
  String drivergender="";
...
class _TrackingFromState extends State<TrackingFrom> {
  ...
  Future<String> getlocation() async{
    ...
    destination= LatLng(double.parse(widget.driverLatitude),double.parse(widget.driverLongitude));
    destinationDistance= ltlng.LatLng(double.parse(widget.driverLatitude),double.parse(widget.driverLongitude));
    var ky = 40000 / 360;
